...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-index">
    ...
    <p>
        <?= "<?= " ?>Html::a(<?= $generator->generateString('เพิ่ม<?= '.'Html::encode($this->title) ?>' . Inflector::camel2words(StringHelper::basename($generator->modelClass))) ?>, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <div class="row">
        <div class="col-lg-12">
