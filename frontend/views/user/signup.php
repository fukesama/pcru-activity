...
<div class="container-fluid" >
    ...
    <div class="row" name='officerRow' style="display:none">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 ">
            <?php $data=ArrayHelper::map(\frontend\models\Prefix::find()->all(), 'pre_id', 'pre_name'); ?>
    ...
    <div class="row" name='collegianRow' style="display:none">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            ...
            [
                'data'=>ArrayHelper::map(frontend\models\Faculty::find()
    ...
    <div class="row" name='collegianRow' style="display:none">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <?php $uc=ArrayHelper::map(frontend\models\Branch::find()->where(['faculty_id'=>$modeluc->faculty_id])
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    ...
                    echo $form->field($model, 'password_hash')->passwordInput(['disabled'=>'disabled','placeholder'=>$text])->label('รหัสผ่าน') ?>
...
$(window).on('load',function(){changeBranch(!$fac?'':'true');eUser($('#level_user').val());});
JS;
