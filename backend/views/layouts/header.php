			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					if (Yii::$app->user->isGuest) {
						...
						<li>
							<a href="<?=Url::to(['/site/changepassword'])?>" style="font-weight: bold;">
								<p class='hidden-lg hidden-md'>
									<i class="material-icons" style="display: block;">person</i>เปลี่ยนรหัสผ่าน
								</p>
								<p class='hidden-xs hidden-sm' style="float: left;">
									<i class="material-icons" style="display: block;float: left;">person</i>เปลี่ยนรหัสผ่าน
								</p>
							</a>
						</li>
						<li>
