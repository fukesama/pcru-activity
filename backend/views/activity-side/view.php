...
$this->title = "รายละเอียดด้านของกิจกรรม";
$this->params['breadcrumbs'][] = ['label' => 'ด้านของกิจกรรม', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="activity-side-view">
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-stats">
                ...
                <div class="btn btnhover btn-warning" style="">
                    ...
                    <a href="<?=Url::to(['update', 'id' => $model->side_id])?>" id="add" data-toggle="tooltip" data-placement="top" title="<?=$add?>" style=""><i class="material-icons" style="font-size: 30px">create</i><?=$add?></a>
                </div>
                <div class="btn btnhover btn-danger" style="">
                    <?php $add='ลบ ( '.$this->title.' )' ?>
                    <?= Html::a(Yii::t('app', '<i class="material-icons" style="font-size: 30px">delete</i>'.$add.'</a>'), ['delete', 'id' => $model->side_id], [
                    'data' => [
