...
$this->title = 'แก้ไขวันที่ดำเนินกิจกรรม: ' . $model->acoyd_id;
    $this->params['breadcrumbs'][] = ['label' => 'วันที่ดำเนินกิจกรรม', 'url' => ['index']];
    $this->params['breadcrumbs'][] = ['label' => $model->acoyd_id, 'url' => ['view', 'id' => $model->acoyd_id]];
    $this->params['breadcrumbs'][] = 'แก้ไข';
    ?>
    <div class="activity-ofyear-detail-update">
        <div class="row">
