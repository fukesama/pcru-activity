...
/**
 * UserCollegianSearch represents the model behind the search form of `backend\models\UserCollegian`.
 */
class UserCollegianSearch extends UserCollegian
{
    ...
    public function rules()
    {
        return [
            [['user_id'], 'integer'],
            [['pre_id', 'uc_fname', 'uc_lname', 'faculty_id', 'branch_id', 'address','ver'], 'safe'],
        ];
    }
